...
class MelConfig:
    ...
    # identity. Generated by scripts/compute_mel_stats.py. Removes the per-channel envelope offset
    # (common-mode the aligner's RMSNorm can't — no mean subtraction) + per-channel std spread.
    stats_path: Optional[str] = "models/mel_logmel_stats.pt"
